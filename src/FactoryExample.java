public class FactoryExample {
	...
	public void getResult(Factory mainFactory, char mainFactorySkill, IWorkingTogether partner) {
		...
		int mainWork = mainFactory.makeProducts(mainFactorySkill);
		System.out.println("하루 생산량 = " + mainWork);
		int partnerWork = partner.workTogether(partner);
		System.out.printf("파트너 공장 [%s] 협력 시 추가 생산량 = %d\n",partner.partnerName(partner), partnerWork);
		System.out.println("--------------------------------------------------------------");
	}
}
